...
export function makeDeckAge1(): Card[] {
	return [
		...
		{ id: 8, name: 'Lumber Yard', type: 'resource', effect: { resources: { wood: 1 } } },
		...
		{ id: 13, name: 'Clay Pool', type: 'resource', effect: { resources: { clay: 1 } } },
		{ id: 14, name: 'Ore Vein', type: 'resource', effect: { resources: { ore: 1 } } },
		{ id: 15, name: 'Lumber Yard', type: 'resource', effect: { resources: { wood: 1 } } },
		{ id: 16, name: 'Stone Pit', type: 'resource', effect: { resources: { stone: 1 } } },
		...
		{ id: 21, name: 'Ore Vein', type: 'resource', effect: { resources: { ore: 1 } } }
	];
}
